...
export default function LetterForm({ siteId, settings }: { siteId: string; settings: SiteSettings }) {
  ...
  return (
    ...
    >
      ...
      <label className="block">
        ...
        <textarea name="letter_content" defaultValue={settings.letter_content} rows={8} className="input" />
      </label>
